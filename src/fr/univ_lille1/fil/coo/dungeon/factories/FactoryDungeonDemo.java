...
import fr.univ_lille1.fil.coo.dungeon.items.weapons.ItemWeaponKatana;
...
public class FactoryDungeonDemo implements FactoryDungeon {
	...
	public Dungeon createDungeon() {
		...
		ItemWeapon k = new ItemWeaponKatana();
		...
		roomWithPotion.setChestContent(new Inventory(new ItemStack(p, 3), new ItemStack(b, 1), new ItemStack(k, 1)));
